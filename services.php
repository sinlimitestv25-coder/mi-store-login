...
<head>
  ...
  <title>SERVICIOS - <?= APP_NAME ?></title>title>
<style>
  *{box-sizing:border-box;}
  ...
  <div class="layout">
        <div class="sidebar">
                <h2>NUEVO SERVICIO</h2>h2>
                <p>Crea servicios con logo editable por URL.</p>p>
              <form method="POST">
                        ...
                        <button type="submit" class="btn">CREAR SERVICIO</button>button>
              </form>form>
        </div>div>
        <div class="main-panel">
                <h2>SERVICIOS DISPONIBLES</h2>h2>
                <p>Servicios globales del admin y servicios propios del usuario.</p>p>
              <div class="services-grid">
                        <?php if (empty($servicios)): ?>
            <div class="empty-box">No hay servicios aun. Crea el primero.</div>div>
                        <?php endif; ?>
            ...
            <div class="service-card">
                  ...
                  <img src="<?= htmlspecialchars($s['logo_url']) ?>" alt="<?= htmlspecialchars($s['nombre']) ?>" onerror="this.parentElement.innerHTML='📡'"/>
                          ...
                          <div class="service-info">
                                          ...
                                          <div class="service-creator">Creado por: <?= htmlspecialchars($s['creador']) ?></div>div>
