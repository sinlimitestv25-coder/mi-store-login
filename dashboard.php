...
<head>
    ...
    <body>
            ...
            <div class="gw"></div>div>
            <div class="wrap">
                        <div class="topbar">
                                        <div class="brand-area">
                                                            <?php if(!empty($user['logo_url'])): ?>
                        <img src="<?php echo htmlspecialchars($user['logo_url']); ?>" alt="Logotipo" class="brand-logo">
                                                            <?php endif; ?>
                <span class="brand-name">MI STORE</span>span>
                        ...
                        <div class="session-bar">Sesion activa como: <strong><?php echo htmlspecialchars($user['email']??''); ?></strong></div>div>
                        <div class="quick-title">ACCESOS RAPIDOS</div>div>
                        <div class="quick-grid">
                                        <a href="services.php" class="quick-card g1"><div class="icon">S</div>div><div class="label">SERVICIOS</div>div></a>a>
                                        <a href="clients.php" class="quick-card g2"><div class="icon">C</div>div><div class="label">CLIENTES</div>div></a>a>
                                        <a href="users.php" class="quick-card g3"><div class="icon">U</div>div><div class="label">USUARIOS</div>div></a>a>
                                        <a href="#" class="quick-card g4"><div class="icon">$</div>div><div class="label">CREDITOS</div>div></a>a>
                                        <a href="settings.php" class="quick-card g5"><div class="icon">⚙</div>div><div class="label">CONFIGURACION</div>div></a>a>
                                        <a href="clientes_whatsapp.php" class="quick-card g4"><div class="icon">📱</div>div><div class="label">WHATSAPP</div>div></a>a>
                        </div>div>
                        <div class="stats-grid">
                                        <div class="stat-card"><div class="stat-label">CLIENTES</div>div><div class="stat-value"><?php echo $total_clientes; ?></div><div class="stat-desc">Control total de clientes registrados</div>div></div>div>
                                        <div class="stat-card"><div class="stat-label">SERVICIOS</div>div><div class="stat-value"><?php echo $total_servicios; ?></div><div class="stat-desc">Catalogo global y servicios propios</div>div></div>div>
                                        <div class="stat-card"><div class="stat-label">USUARIOS</div>div><div class="stat-value"><?php echo $total_usuarios; ?></div><div class="stat-desc">Gestion de usuarios del sistema</div>div></div>div>
                                        <div class="stat-card"><div class="stat-label">CREDITOS</div>div><div class="stat-value"><?php echo number_format((float)($user['creditos']??0)); ?></div><div class="stat-desc">Balance disponible en cuenta</div>div></div>div>
                        </div>div>
            </div>div>
    </body>body>
</html>html>
