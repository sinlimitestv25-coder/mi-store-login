...
<head>
  ...
  <style>
    *{box-sizing:border-box;}
    ...
    .quick-card.grad4{background:linear-gradient(135deg,rgba(16,185,129,0.18),rgba(178,102,255,0.14));}
    .quick-card.grad5{background:linear-gradient(135deg,rgba(59,130,246,0.22),rgba(178,102,255,0.12));}
    .quick-card.grad6{background:linear-gradient(135deg,rgba(245,158,11,0.22),rgba(16,185,129,0.12));}
