...
<div class="wrap">
 ...
 <a href="clientes_whatsapp.php" class="quick-card g4"><div class="icon">📱</div>div><div class="label">WHATSAPP</div>div></a>a>    <div class="stat-card"><div class="stat-label">CLIENTES</div><div class="stat-value"><?php echo $total_clientes; ?></div><div class="stat-desc">Control total de clientes registrados</div></div>
